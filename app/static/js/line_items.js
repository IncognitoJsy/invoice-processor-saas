...
(function () {
  ...
  function renderRow(item) {
    ...
    const actionCell = ctx.editable
      ...
      : '';
    const rowCls = excluded ? 'opacity-50 bg-gray-50 dark:bg-gray-900/30' : '';
