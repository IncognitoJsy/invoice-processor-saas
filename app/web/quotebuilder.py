...
@bp.route('/api/projects/<int:project_id>/documents/<int:doc_id>/parse-legend', methods=['POST'])
@login_required
def parse_legend(project_id, doc_id):
    """
    Use Claude Vision to automatically parse the drawing legend
    and create symbol templates.
    """
    from app.models.project import Project, ProjectDocument
    from app.models.takeoff import TakeoffSymbolTemplate
    from app.extensions import db
            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": """Analyze this electrical drawing and find the LEGEND or KEY section.    
