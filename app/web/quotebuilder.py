...
# =============================================================================
# TAKEOFF - AI SYMBOL DETECTION (V4)
# =============================================================================
...
def detect_symbols_ai(project_id, doc_id):
    ...
    try:
        ...
        saved_detections = []
        for d in detections:
            template = next((t for t in templates if t.label and d.get('template_name') and t.label.lower() in d.get('template_name', '').lower()), None)
